    ...
    if (year.value.length == 0 || Number(year.value) > ano) {
        ...
        if (pet[0].checked && sex[0].checked) {
            if (idade < 1) {
                ...
                img.setAttribute('src', 'fotos/gato-filhote.png')
                //nenem
            } else if (idade <= 7) {
                genero = 'gata fêmea adulta'
                img.setAttribute('src', 'fotos/gato-adulto.png')
                //gatinha adulta
            } else if (idade <= 12) {
                genero = 'gata fêmea idosa'
                img.setAttribute('src', 'fotos/gato-idoso.png')
                //gatinha idosa
            ...
            if (idade < 1) {
                ...
                img.setAttribute('src', 'fotos/cachorro-filhote.png')
            } else if (idade <= 7) {
                genero = 'cachorra fêmea adulta'
                img.setAttribute('src', 'fotos/cachorro-adulto.png')
            } else if (idade <= 12) {
                genero = 'cachorra fêmea idosa'
                img.setAttribute('src', 'fotos/cachorro-idoso.png')
            } else if (idade > 12 && idade <= 30) {
